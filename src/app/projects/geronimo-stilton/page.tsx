    ...
    return (
        <div className="min-h-screen min-w-screen flex flex-col gap-3">
            <ProjectHero 
                ...
                subtitle="Full-stack Creative Coding Project"
                backgroundImage="/images/geronimo-stilton/mouse_motif.jpg"
            ...
            <div id="demo-videos" className="flex flex-row gap-4 justify-center overflow-hidden">
                <video 
